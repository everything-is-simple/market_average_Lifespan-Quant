"""Structure 结构位快照构建脚本 — 分批构建 + 断点续传 + 日增量。
...
用法：
    ...
    # 指定股票
    python scripts/structure/build_structure_snapshot.py --date 2026-04-07 --codes 000001.SZ 600519.SH

    # 参数预览
    python scripts/structure/build_structure_snapshot.py --date 2026-04-07 --dry-run
"""
...
def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Structure 结构位快照构建：market_base → structure.duckdb"
    )
...
def main() -> None:
    ...
    from lq.structure.pipeline import (
