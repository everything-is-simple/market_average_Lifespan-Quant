...
1. 新增 `07` 号 design / `02` 号 spec，正式冻结 `MALF` 的四格上下文与生命周期三轴排名合同。
2. 对已跑偏的 `02/03/05` 号 design、`01` 号 spec，以及相关实现代码补齐"历史兼容/放弃原因"标记。
...
1. `07` 号 design / `02` 号 spec 已形成，且明确写清字段、表、runner、PAS 接口、position 接口。
