        ...
        for sig_dict in signals:
            try:
                ...
                pas_signal = PasSignal(
                    ...
                    long_background_2=sig_dict.get("long_background_2"),
                    intermediate_role_2=sig_dict.get("intermediate_role_2"),
                    malf_context_4=sig_dict.get("malf_context_4", "UNKNOWN"),
                    amplitude_rank_low=sig_dict.get("amplitude_rank_low"),
                    amplitude_rank_high=sig_dict.get("amplitude_rank_high"),
                    amplitude_rank_total=sig_dict.get("amplitude_rank_total"),
                    duration_rank_low=sig_dict.get("duration_rank_low"),
                    duration_rank_high=sig_dict.get("duration_rank_high"),
                    duration_rank_total=sig_dict.get("duration_rank_total"),
                    new_price_rank_low=sig_dict.get("new_price_rank_low"),
                    new_price_rank_high=sig_dict.get("new_price_rank_high"),
                    new_price_rank_total=sig_dict.get("new_price_rank_total"),
                    lifecycle_rank_low=sig_dict.get("lifecycle_rank_low"),
                    lifecycle_rank_high=sig_dict.get("lifecycle_rank_high"),
                    lifecycle_rank_total=sig_dict.get("lifecycle_rank_total"),
                    amplitude_quartile=sig_dict.get("amplitude_quartile"),
                    duration_quartile=sig_dict.get("duration_quartile"),
                    new_price_quartile=sig_dict.get("new_price_quartile"),
                    lifecycle_quartile=sig_dict.get("lifecycle_quartile"),
                    monthly_state=sig_dict.get("monthly_state"),
                    weekly_flow=sig_dict.get("weekly_flow"),
